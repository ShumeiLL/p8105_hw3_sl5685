...
![](p8105_hw3_sl5685_files/figure-gfm/unnamed-chunk-13-1.png)<!-- --> In
2020, Fridays had the most riding time, and Thursday the least, but in
2024, riding time was roughly the same every day.
...
![](p8105_hw3_sl5685_files/figure-gfm/unnamed-chunk-14-1.png)<!-- --> As
can be seen from the chart, the riding duration of both types of bikes
is mostly less than 50 minutes. Members ride more frequently, while more
people choose classic bicycles.
